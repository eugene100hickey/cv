...
create_CV_object <-  function(data_location,
  ...
  z <- cv$entries_data %>%
    dplyr::filter(title == "Final Year Projects") %>%
    tidyr::unite(
      starts_with("descr"),
...
print_skill_bars <- function(cv, out_of = 5, bar_color = "#26838e", bar_background = "#d9d9d9", glue_template = "default"){
