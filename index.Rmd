...
- <i class="fa fa-envelope"></i> eugene.hickey@tudublin.ie
- <i class="fa fa-twitter"></i> eugene100hickey
- <i class="fa fa-github"></i> github.com/eugene100hickey
- <i class="fa fa-link"></i> [nickstrayer.me](http://nickstrayer.me/)
- <i class="fa fa-phone"></i> +353 1 404 2820
...
The source code is available at [github.com/eugene100hickey/cv](https://github.com/eugene100hickey/cv).
